...
public class Main extends SherlockActivity implements ParserEventListener, OnClickListener {
	...
	public static final String XML_URL = "http://devconf.ru/2015/schedule/xml";
	...
	public void performUpdate() {
		...
		if (networkInfo != null && networkInfo.isConnected()) {
			...
			final Thread t = new Thread(new BackgroundUpdater(
					handler, Main.this, getApplicationContext(), true, false));
			t.start();
		} else {
			// no internet connection available
			toast(getString(R.string.cannot_update));
		}
	}
	...
	public Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case TAGEVENT:
				...
				tvProgress.setText(getResources().getQuantityString(R.plurals.fetched_events, counter, counter));
			...
			case DONEFETCHING:
				...
				break;
			case DONELOADINGDB:
				final String doneDb = getString(R.string.done_loading);
